...
#ifndef CUTERADIO_REQUEST_H
#define CUTERADIO_REQUEST_H

#include "cuteradio_global.h"
#include <QObject>
#include <QVariantMap>
...
class CUTERADIOSHARED_EXPORT Request : public QObject
{
    Q_OBJECT
